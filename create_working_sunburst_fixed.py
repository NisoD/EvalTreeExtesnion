#!/usr/bin/env python3
"""
Working DOVE-Based Sunburst Weakness Tree (Fixed)
...
def main():
    ...
    try:
        ...
        if main_fig:
            main_fig.write_html("improved_dove_sunburst.html")
            print("✅ Improved sunburst saved to improved_dove_sunburst.html")

        # Create ultra-focused version (top 25)
        print("Creating ultra-focused sunburst...")
        focused_fig, focused_data = create_weakness_sunburst(
            weakness_data, title="DOVE Critical Weaknesses", top_n=25
        )
        if focused_fig:
            focused_fig.write_html("improved_dove_focused_sunburst.html")
            print("✅ Focused sunburst saved to improved_dove_focused_sunburst.html")
        ...
        print("  • improved_dove_sunburst.html - Top 50 weakest (4-7 word labels)")
        print("  • improved_dove_focused_sunburst.html - Top 25 most critical")

        print("\n🎯 Key Improvements:")
        print("  • Shortened labels to 4-7 key words")
        print("  • Fixed colors: Red = Critical/Weak, Blue = Strong")
        print("  • Unique IDs prevent rendering issues")
        print("  • Interactive hover with full details")

        print("\n📊 Open improved_dove_sunburst.html in your browser!")
