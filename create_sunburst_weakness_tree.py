#!/usr/bin/env python3
"""
DOVE-Based Sunburst Weakness Tree
...
def extract_hierarchical_data(node, dove_scores, path="", level=0, max_levels=4):
    ...
    if len(capability) > 40:
        capability_short = capability[:37] + "..."
    else:
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(text="Red=Critical, Orange=High, Yellow=Moderate, Green=Low", 
                 x=0.25, y=0.02, xref="paper", yref="paper", showarrow=False, font_size=10),
            dict(text="Colors by hierarchical level", 
                 x=0.75, y=0.02, xref="paper", yref="paper", showarrow=False, font_size=10)
        ]
    )
...
def main():
    ...
    print("Creating DOVE-Based Sunburst Weakness Tree...")
    ...
    try:
        ...
        if dove_fig:
            ...
            dove_fig.write_image("dove_sunburst_weakness.png", width=800, height=800)
            dove_fig.write_image("dove_sunburst_weakness.pdf", width=800, height=800)
            print("DOVE sunburst saved to dove_sunburst_weakness.html/png/pdf")
        ...
        if original_fig:
            ...
            original_fig.write_image("original_mmlu_sunburst.png", width=800, height=800)
            original_fig.write_image("original_mmlu_sunburst.pdf", width=800, height=800)
            print("Original sunburst saved to original_mmlu_sunburst.html/png/pdf")
        ...
        if comparative_fig:
            ...
            comparative_fig.write_image("comparative_sunburst.png", width=1600, height=800)
            comparative_fig.write_image("comparative_sunburst.pdf", width=1600, height=800)
            print("Comparative sunburst saved to comparative_sunburst.html/png/pdf")
        ...
        print("  • dove_sunburst_weakness.html/png/pdf - Interactive DOVE weakness sunburst")
        print("  • original_mmlu_sunburst.html/png/pdf - Original MMLU structure sunburst")
        print("  • comparative_sunburst.html/png/pdf - Side-by-side comparison")
